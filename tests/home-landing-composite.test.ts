...
describe("home landing composite contract", () => {
  ...
  it("uses reduced-motion guards and restrained product hover selectors", () => {
    ...
    expect(shelfCss).toContain("--mithron-image-placeholder: transparent");
  ...
  it("uses product shelves followed by distinct mission-world editorial sections", () => {
    ...
    expect(shelfSection).toContain("ProductShelfContainer");
    expect(source("components/product/product-shelf-container.tsx")).toContain('data-product-shelf-container="true"');
    expect(shelfSection).toContain('data-shelf-layout="dji"');
    ...
    expect(shelfSection).toContain("ProductShelfRightStack");
    const viewAllCompact = source("sections/home/product-shelf-view-all-compact-card.tsx");
    expect(viewAllCompact).toContain('data-testid="home-product-view-all-card"');
    const guideCard = source("sections/home/product-shelf-buying-guide-card.tsx");
    expect(guideCard).toContain('data-testid="home-product-shelf-guide-card"');
    expect(shelfSection).toContain("guideHeadline={config.guideHeadline}");
    expect(shelfSection).toContain("viewAllLabel={config.viewAllLabel}");
    ...
    expect(shelfCss).toContain('[data-shelf-layout="dji"]');
    expect(shelfCss).toContain(".shelfRightStack");
    ...
    const viewAllCompactCss = readFileSync(join(process.cwd(), "sections/home/product-shelf-view-all-compact-card.module.css"), "utf8");
    expect(viewAllCompactCss).toContain(".card");
    expect(viewAllCompactCss).toContain(".label");
    const guideCardCss = readFileSync(join(process.cwd(), "sections/home/product-shelf-buying-guide-card.module.css"), "utf8");
    expect(guideCardCss).toContain(".headline");
    expect(guideCardCss).toContain(".imageFrame");
    expect(guideCardCss).toContain(".cleanBackdrop");
    expect(guideCardCss).toContain("buying-guide-backdrop.png");
    expect(guideCardCss).toContain("--mithron-image-placeholder: transparent");
    expect(guideCardCss).toContain("mix-blend-mode: multiply");
    expect(shelfSection).toContain("guideImage={guideImage}");
  ...
  it("intentionally renders Drone World, Drone Care, and Global Products as catalog-backed shelves", () => {
    ...
    expect(shelfResolution).toContain('guideHeadline: "Which Drone Is Right for Me?"');
    expect(shelfResolution).toContain('viewAllLabel: "All Drones"');
    expect(shelfResolution).toContain('viewAllLabel: "All Accessories"');
    expect(shelfResolution).toContain('viewAllLabel: "All Global Products"');
