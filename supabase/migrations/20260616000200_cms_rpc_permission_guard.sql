-- CMS RPC permission guard: require cms.write unless service_role.
...
grant execute on function public.assert_cms_write_permission() to authenticated, service_role;
...
begin
  perform public.assert_cms_write_permission();
