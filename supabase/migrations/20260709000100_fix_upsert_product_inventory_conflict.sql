-- inventory table enforces UNIQUE (product_slug) via inventory_one_per_product.
-- Align upsert_product_inventory with that constraint (was ON CONFLICT (product_slug, sku) → 42P10).
