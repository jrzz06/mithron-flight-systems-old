-- Allow admin inventory corrections to reduce committed_quantity when stock is lowered.
-- v_committed is already clamped to sellable inside upsert_product_inventory; greatest() blocked reductions.
